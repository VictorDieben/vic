...
public:
    ...
    SeidelResult<T, dims> Calculate(const std::array<T, dims>& objective) { return {}; }
...
public:
    ...
    void AddConstraint(const ConstraintType& constraint)
    {
        ...
        if(a1 > 0. && MinL(a2Overa1, a3Overa1, mH1, mH2))
        {
            mH1 = a2Overa1;
            mH2 = a3Overa1;
        }
        else if(a1 < 0. && MaxL(a2Overa1, a3Overa1, mL1, mL2))
        {
            mL1 = a2Overa1;
            mL2 = a3Overa1;
        }
