...
public:
    ...
    bool Has(EntityId id) { return mComponents.find(id) != mComponents.end(); }
...
class BaseEntitySystem : protected ComponentSystem<Ts>...
{
public:
    template <typename T>
...
template <typename... Ts>
class EntitySystem : public BaseEntitySystem<Ts...>
{
public:
    using EntityType = Entity<BaseEntitySystem<Ts...>>;

    EntityType NewEntity()
    {
        mEntId++;
        EntityType newEntity(mEntId, this);
        return newEntity;
    }
