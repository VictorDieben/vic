...
public:
	...
	void Setup()
	{
		...
		//if (wsOk != 0)
		//{
		//	std::cout << "UdpServer: Unable to start winsock! Error: " << WSAGetLastError() << std::endl;
		//	throw std::runtime_error("UdpServer: Unable to start winsock!");
		//}
...
public:
	...
	void Setup()
	{
		...
		//if (wsOk != 0)
		//{
		//	std::cout << "UdpClient: Unable to start winsock! wsOk: " << wsOk << std::endl;
		//	throw std::runtime_error("UdpClient: unable to start winsock");
		//}
